...
class Authenticator {
    ...
    async get_Access_token(code) {
        ...
        var res = await (0, node_fetch_1.default)(GET_ACCESS_TOKEN_URL, {
            method: 'POST',
    ...
    async is_valid_token(access_token) {
        ...
        var res = await (0, node_fetch_1.default)(TEST_ACCESS_TOKEN, {
            method: "GET",
            headers: header,
        });
    ...
    async get_user_data(access_token) {
        ...
        var res = await (0, node_fetch_1.default)(GET_USER_DATA_URL, {
            method: "GET",
            headers: header,
        });
        return await res.json();
...
//# sourceMappingURL=42-authentication.js.map